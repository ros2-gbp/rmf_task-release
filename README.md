## rmf_task (lyrical) - 2.10.0-1

The packages in the `rmf_task` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical rmf_task` on `Mon, 15 Jun 2026 12:58:08 -0000`
...
## rmf_task (jazzy) - 2.5.1-1

The packages in the `rmf_task` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rmf_task -y` on `Fri, 14 Jun 2024 22:41:48 -0000`
...
## rmf_task (jazzy) - 2.5.0-1

The packages in the `rmf_task` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rmf_task` on `Fri, 14 Jun 2024 22:37:25 -0000`
...
## rmf_task (rolling) - 2.6.0-1

The packages in the `rmf_task` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rmf_task` on `Fri, 14 Jun 2024 22:31:11 -0000`
...
## rmf_task (rolling) - 2.5.0-1

The packages in the `rmf_task` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rmf_task` on `Sun, 02 Jun 2024 23:52:12 -0000`
...
## rmf_task (iron) - 2.2.5-1

The packages in the `rmf_task` repository were released into the `iron` distro by running `/usr/bin/bloom-release --rosdistro iron rmf_task` on `Thu, 28 Mar 2024 15:18:05 -0000`
...
The packages in the `rmf_task` repository were released into the `humble` distro by running `/usr/bin/bloom-release --ros-distro humble --track humble -e rmf_task` on `Thu, 06 Oct 2022 06:50:43 -0000`
